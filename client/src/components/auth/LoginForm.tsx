    ...
    <div className="w-full">
      <div className="bg-white rounded-2xl shadow-soft p-6 sm:p-8 border border-neutral-200">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-neutral-800 mb-2">Welcome Back</h2>
          <p className="text-sm sm:text-base text-neutral-500">Sign in to your account to continue</p>
        </div>
